		...
		for i in range(len(D1)):
			...
			for j in range(d,len(D1)-d):
				...
				if switch=='on': 
					...
					t=logistic(parAlst[dc1][dc2])*logistic(parAlst[I1][I2])*R + logistic(parAlst[dc1][dc2])*(1-logistic(parAlst[I1][I2]))*S + (1-logistic(parAlst[dc1][dc2]))*logistic(parAlst[I1][I2])*T + (1-logistic(parAlst[dc1][dc2]))*(1-logistic(parAlst[I1][I2]))*P 
					t1=logistic(parAlst[dc1][dc2])*logistic(parAlst[I1][I2])*R + logistic(parAlst[dc1][dc2])*(1-logistic(parAlst[I1][I2]))*T + (1-logistic(parAlst[dc1][dc2]))*logistic(parAlst[I1][I2])*S + (1-logistic(parAlst[dc1][dc2]))*(1-logistic(parAlst[I1][I2]))*P 
					EX.append([I1,I2,t1-t])
	for i in EX:
		r=1/(1.0+math.exp(i[2]/5)) 
		i.append(r) 
