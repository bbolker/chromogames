...
def init_sim_stripe(a_range_init,b_range_init,w):
     """
     a_range_init: starting values for odd and even stripes
     """
     parAlst = numpy.zeros((w,w))
     return(None)
    
def init_sim_block(a_range_init,b_range_init,size):
    return(None)
