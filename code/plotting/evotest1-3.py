...
x = EvoAlt4.runsim(w=ww,T=TT,S=SS,roundnum=rn,seed=sd[0],rpt_freq=freq,a_range_init=(al,au),b_range_init=(bl,bu),CHECK=False,result_type='timeseries',mut_sd=(m1,m2,m3),ntype=nntype,mut_type=mtp,nsize=ns)
print('yes')
...
plt.title('seeds=21 a=4.5,4.6 b=0 colour=0,5 mut=0.03(70%)+ PD2E5 Well-mixed w=70')
