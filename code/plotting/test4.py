...
x = EvoAlt6.runsim(a_range_init=(al,au),w=ww,R=RR,P=PP,T=TT,S=SS,roundnum=rn,seed=sd[0],rpt_freq=freq,CHECK=False,result_type='timeseries',mut_sd=(m1,m2,m3),ntype=nntype,mut_type=mtp,nsize=ns,switch='off',init_type='block')
print('yes')
x1 = EvoAlt6.runsim(a_range_init=(al,au),w=ww,P=PP,R=RR,T=TT,S=SS,roundnum=rn,seed=sd[1],rpt_freq=freq,CHECK=False,result_type='timeseries',mut_sd=(m1,m2,m3),ntype=nntype,mut_type=mtp,nsize=ns,switch='off',init_type='block')
print('yes')

import matplotlib.pyplot as plt
 
plt.title('SD R=1 S=0.3 T=1.7 P=0 spatial switch=off w=20 block')
