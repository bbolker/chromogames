...
outfiletest1 = open('SD_ns1_a00_c05_b01_mutadd00-1-1-test.npy','w')

x = EvoAlt2.runsim(roundnum=100000000, a_range_init=(1,1),colour_init=(0,5),R=1,S=0.3,T=1.7,P=0,w=60,seed=10,rpt_freq=1000,CHECK=False,result_type='timeseries', mut_sd=(0.02,0.02,0.02), ntype='neu', mut_type='add',nsize=1,switch='off',b_range_init=(1,1))   
