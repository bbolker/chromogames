...
sys.stderr.write('Testing if the expected value of the payoff is reasonable (ie less than or equal to the sum of the 4 possible payoffs\n') 
## Testing if the expected value of the payoff is reasonable (ie less than or equal to the 4 possible payoffs) 
