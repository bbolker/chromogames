...
sys.stderr.write('Testing if reproductive success for all competing cells is equal if A constant, B=0 and mutation for A turned off.\n') 
## Testing if reproductive success for all competing cells is equal if A constant, B=0 and mutation for A turned off.  
...
def main():
	...
	numpy.save('equalReproductioncheck.npy',x) 
        print('test complete')
